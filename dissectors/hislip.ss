...
;; jerboa-ethereal/dissectors/hislip.ss
;; Auto-generated from wireshark/epan/dissectors/packet-hislip.c
...
(def (dissect-hislip buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "HISLIP parse error: " e)))))

;; dissect-hislip: parse HISLIP from bytevector
