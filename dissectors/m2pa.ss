...
;; jerboa-ethereal/dissectors/m2pa.ss
;; Auto-generated from wireshark/epan/dissectors/packet-m2pa.c
;; RFC 4165
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-m2pa buffer)
  "MTP2 Peer Adaptation Layer"
  (try
    ;; TODO: no extractable fields found for m2pa
    (ok '())

    (catch (e)
      (err (str "M2PA parse error: " e)))))

;; dissect-m2pa: parse M2PA from bytevector
