...
;; jerboa-ethereal/dissectors/ipsi-ctl.ss
;; Auto-generated from wireshark/epan/dissectors/packet-ipsi_ctl.c
...
(def (dissect-ipsi-ctl buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "IPSI-CTL parse error: " e)))))

;; dissect-ipsi-ctl: parse IPSI-CTL from bytevector
