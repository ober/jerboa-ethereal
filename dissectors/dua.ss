...
;; jerboa-ethereal/dissectors/dua.ss
;; Auto-generated from wireshark/epan/dissectors/packet-dua.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-dua buffer)
  "DPNSS/DASS2-User Adaptation Layer"
  (try
    ;; TODO: no extractable fields found for dua
    (ok '())

    (catch (e)
      (err (str "DUA parse error: " e)))))

;; dissect-dua: parse DUA from bytevector
