...
;; jerboa-ethereal/dissectors/signal-pdu.ss
;; Auto-generated from wireshark/epan/dissectors/packet-signal_pdu.c
...
(def (dissect-signal-pdu buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "SIGNAL-PDU parse error: " e)))))

;; dissect-signal-pdu: parse SIGNAL-PDU from bytevector
