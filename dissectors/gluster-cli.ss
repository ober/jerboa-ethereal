...
;; jerboa-ethereal/dissectors/gluster-cli.ss
;; Auto-generated from wireshark/epan/dissectors/packet-gluster_cli.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-gluster-cli buffer)
  "Gluster CLI"
  (try
    ;; TODO: no extractable fields found for gluster-cli
    (ok '())

    (catch (e)
      (err (str "GLUSTER-CLI parse error: " e)))))

;; dissect-gluster-cli: parse GLUSTER-CLI from bytevector
