...
;; jerboa-ethereal/dissectors/m2tp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-m2tp.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-m2tp buffer)
  "MTP 2 Transparent Proxy"
  (try
    ;; TODO: no extractable fields found for m2tp
    (ok '())

    (catch (e)
      (err (str "M2TP parse error: " e)))))

;; dissect-m2tp: parse M2TP from bytevector
