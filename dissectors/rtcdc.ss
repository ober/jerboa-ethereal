...
;; jerboa-ethereal/dissectors/rtcdc.ss
;; Auto-generated from wireshark/epan/dissectors/packet-rtcdc.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-rtcdc buffer)
  "WebRTC Datachannel Protocol"
  (try
    ;; TODO: no extractable fields found for rtcdc
    (ok '())

    (catch (e)
      (err (str "RTCDC parse error: " e)))))

;; dissect-rtcdc: parse RTCDC from bytevector
