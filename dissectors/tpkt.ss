...
;; jerboa-ethereal/dissectors/tpkt.ss
;; Auto-generated from wireshark/epan/dissectors/packet-tpkt.c
;; RFC 1006
...
(def (dissect-tpkt buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "TPKT parse error: " e)))))

;; dissect-tpkt: parse TPKT from bytevector
