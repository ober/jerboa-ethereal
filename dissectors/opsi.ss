...
;; jerboa-ethereal/dissectors/opsi.ss
;; Auto-generated from wireshark/epan/dissectors/packet-opsi.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-opsi buffer)
  "Open Policy Service Interface"
  (try
    (let* (
           (attribute-length (unwrap (read-u16be buffer 0)))
           )
    ...
    (catch (e)
      (err (str "OPSI parse error: " e)))))

;; dissect-opsi: parse OPSI from bytevector
