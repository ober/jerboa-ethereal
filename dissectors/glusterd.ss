...
;; jerboa-ethereal/dissectors/glusterd.ss
;; Auto-generated from wireshark/epan/dissectors/packet-glusterd.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-glusterd buffer)
  "Gluster Daemon"
  (try
    ;; TODO: no extractable fields found for glusterd
    (ok '())

    (catch (e)
      (err (str "GLUSTERD parse error: " e)))))

;; dissect-glusterd: parse GLUSTERD from bytevector
