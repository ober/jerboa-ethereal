...
;; jerboa-ethereal/dissectors/mrp-mvrp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-mrp_mvrp.c
...
(def (dissect-mrp-mvrp buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "MRP-MVRP parse error: " e)))))

;; dissect-mrp-mvrp: parse MRP-MVRP from bytevector
