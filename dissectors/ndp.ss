...
;; jerboa-ethereal/dissectors/ndp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-ndp.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-ndp buffer)
  "Nortel Discovery Protocol"
  (try
    ;; TODO: no extractable fields found for ndp
    (ok '())

    (catch (e)
      (err (str "NDP parse error: " e)))))

;; dissect-ndp: parse NDP from bytevector
