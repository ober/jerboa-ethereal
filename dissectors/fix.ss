...
;; jerboa-ethereal/dissectors/fix.ss
;; Auto-generated from wireshark/epan/dissectors/packet-fix.c
...
(def (dissect-fix buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "FIX parse error: " e)))))

;; dissect-fix: parse FIX from bytevector
