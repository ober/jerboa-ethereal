...
;; jerboa-ethereal/dissectors/communityid.ss
;; Auto-generated from wireshark/epan/dissectors/packet-communityid.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-communityid buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "COMMUNITYID parse error: " e)))))

;; dissect-communityid: parse COMMUNITYID from bytevector
