...
;; jerboa-ethereal/dissectors/chargen.ss
;; Auto-generated from wireshark/epan/dissectors/packet-chargen.c
;; RFC 864
...
(def (dissect-chargen buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "CHARGEN parse error: " e)))))

;; dissect-chargen: parse CHARGEN from bytevector
