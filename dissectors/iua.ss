...
;; jerboa-ethereal/dissectors/iua.ss
;; Auto-generated from wireshark/epan/dissectors/packet-iua.c
;; RFC 3057
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-iua buffer)
  "ISDN Q.921-User Adaptation Layer"
  (try
    ;; TODO: no extractable fields found for iua
    (ok '())

    (catch (e)
      (err (str "IUA parse error: " e)))))

;; dissect-iua: parse IUA from bytevector
