...
;; jerboa-ethereal/dissectors/xip.ss
;; Auto-generated from wireshark/epan/dissectors/packet-xip.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-xip buffer)
  "eXpressive Internet Protocol"
  (try
    ;; TODO: no extractable fields found for xip
    (ok '())

    (catch (e)
      (err (str "XIP parse error: " e)))))

;; dissect-xip: parse XIP from bytevector
