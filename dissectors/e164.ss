...
;; jerboa-ethereal/dissectors/e164.ss
;; Auto-generated from wireshark/epan/dissectors/packet-e164.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-e164 buffer)
  "ITU-T E.164 number"
  (try
    ;; TODO: no extractable fields found for e164
    (ok '())

    (catch (e)
      (err (str "E164 parse error: " e)))))

;; dissect-e164: parse E164 from bytevector
