...
;; jerboa-ethereal/dissectors/cl3.ss
;; Auto-generated from wireshark/epan/dissectors/packet-cl3.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-cl3 buffer)
  "CableLabs Layer 3 Protocol"
  (try
    (let* (
    ...
    (catch (e)
      (err (str "CL3 parse error: " e)))))

;; dissect-cl3: parse CL3 from bytevector
