...
;; jerboa-ethereal/dissectors/pw-cesopsn.ss
;; Auto-generated from wireshark/epan/dissectors/packet-pw_cesopsn.c
;; RFC 5086
...
(def (dissect-pw-cesopsn buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "PW-CESOPSN parse error: " e)))))

;; dissect-pw-cesopsn: parse PW-CESOPSN from bytevector
