...
;; jerboa-ethereal/dissectors/bicc-mst.ss
;; Auto-generated from wireshark/epan/dissectors/packet-bicc_mst.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-bicc-mst buffer)
  "3GPP BICC MST"
  (try
    ;; TODO: no extractable fields found for bicc-mst
    (ok '())

    (catch (e)
      (err (str "BICC-MST parse error: " e)))))

;; dissect-bicc-mst: parse BICC-MST from bytevector
