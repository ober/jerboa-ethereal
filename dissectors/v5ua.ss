...
;; jerboa-ethereal/dissectors/v5ua.ss
;; Auto-generated from wireshark/epan/dissectors/packet-v5ua.c
;; RFC 3807
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-v5ua buffer)
  "V5.2-User Adaptation Layer"
  (try
    ;; TODO: no extractable fields found for v5ua
    (ok '())

    (catch (e)
      (err (str "V5UA parse error: " e)))))

;; dissect-v5ua: parse V5UA from bytevector
