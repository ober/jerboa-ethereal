...
;; jerboa-ethereal/dissectors/ecp-oui.ss
;; Auto-generated from wireshark/epan/dissectors/packet-ecp_oui.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-ecp-oui buffer)
  "ECP Protocol"
  (try
    (let* (
           (tlv-type (unwrap (read-u16be buffer 0)))
    ...
    (catch (e)
      (err (str "ECP-OUI parse error: " e)))))

;; dissect-ecp-oui: parse ECP-OUI from bytevector
