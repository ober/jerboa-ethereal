...
;; jerboa-ethereal/dissectors/ipp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-ipp.c
;; RFC 2910
...
(def (dissect-ipp buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "IPP parse error: " e)))))

;; dissect-ipp: parse IPP from bytevector
