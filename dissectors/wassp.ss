...
(def (dissect-wassp buffer)
  ...
  (try
    (let* (
           (tlv-unknown (unwrap (read-u32be buffer 178)))
           (tlv-type-sub (unwrap (read-u16be buffer 178)))
           (tlv-length (unwrap (read-u16be buffer 186)))
           (tlv-value-string (unwrap (slice buffer 190 1)))
           (tlv-value-ip (unwrap (read-u32be buffer 190)))
           (tlv-eid-rustate (unwrap (read-u8 buffer 190)))
           (tlv-value-int (unwrap (read-u8 buffer 190)))
           (macaddr (unwrap (slice buffer 190 6)))
           (tlv-value-octext (unwrap (slice buffer 192 1)))
           (tlv-invalid (unwrap (read-u32be buffer 192)))
           (mu-netflow-record (unwrap (slice buffer 192 1)))
           (mu-netflow-in-bytes (unwrap (read-u32be buffer 192)))
           (mu-netflow-in-packets (unwrap (read-u32be buffer 196)))
           (mu-netflow-ip-protocol-number (unwrap (read-u8 buffer 200)))
           (mu-netflow-source-tos (unwrap (read-u8 buffer 201)))
           (mu-netflow-source-port (unwrap (read-u16be buffer 202)))
           (mu-netflow-source-ip (unwrap (read-u32be buffer 204)))
           (mu-netflow-input-snmp (unwrap (read-u16be buffer 208)))
           (mu-netflow-dest-port (unwrap (read-u16be buffer 210)))
           (mu-netflow-dest-ip (unwrap (read-u32be buffer 212)))
           (mu-netflow-output-snmp (unwrap (read-u16be buffer 216)))
           (mu-netflow-last-time (unwrap (read-u32be buffer 218)))
           (mu-netflow-first-time (unwrap (read-u32be buffer 222)))
           (mu-netflow-in-source-mac (unwrap (slice buffer 226 6)))
           (mu-netflow-in-dest-mac (unwrap (slice buffer 232 6)))
           (mu-type (unwrap (read-u8 buffer 238)))
           (mu-qos (unwrap (read-u8 buffer 238)))
           (mu-action-ssid (unwrap (read-u16be buffer 238)))
           (mu-action-field-value (unwrap (read-u16be buffer 238)))
           (mu-mac (unwrap (slice buffer 238 6)))
           (mu-resv1 (unwrap (read-u16be buffer 238)))
           )
