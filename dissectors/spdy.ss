...
(def (dissect-spdy buffer)
  ...
  (try
    (let* (
           ...
           (num-settings (unwrap (read-u32be buffer 26)))
           (flags (unwrap (read-u8 buffer 30)))
           (flags-persist-value (unwrap (read-u8 buffer 30)))
           (flags-persisted (unwrap (read-u8 buffer 30)))
           (setting-value (unwrap (read-u32be buffer 34)))
           (ping-id (unwrap (read-u32be buffer 38)))
           (window-update-delta (unwrap (read-u32be buffer 46)))
           )
