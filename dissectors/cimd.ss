...
;; jerboa-ethereal/dissectors/cimd.ss
;; Auto-generated from wireshark/epan/dissectors/packet-cimd.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-cimd buffer)
  "Computer Interface to Message Distribution"
  (try
    ;; TODO: no extractable fields found for cimd
    (ok '())

    (catch (e)
      (err (str "CIMD parse error: " e)))))

;; dissect-cimd: parse CIMD from bytevector
