...
;; jerboa-ethereal/dissectors/quakeworld.ss
;; Auto-generated from wireshark/epan/dissectors/packet-quakeworld.c
...
(def (dissect-quakeworld buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "QUAKEWORLD parse error: " e)))))

;; dissect-quakeworld: parse QUAKEWORLD from bytevector
