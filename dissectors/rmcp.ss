...
;; jerboa-ethereal/dissectors/rmcp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-rmcp.c
...
(def (dissect-rmcp buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "RMCP parse error: " e)))))

;; dissect-rmcp: parse RMCP from bytevector
