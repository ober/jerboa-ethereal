...
;; jerboa-ethereal/dissectors/rtag.ss
;; Auto-generated from wireshark/epan/dissectors/packet-rtag.c
...
(def (dissect-rtag buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "RTAG parse error: " e)))))

;; dissect-rtag: parse RTAG from bytevector
