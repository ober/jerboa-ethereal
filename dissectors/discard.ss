...
;; jerboa-ethereal/dissectors/discard.ss
;; Auto-generated from wireshark/epan/dissectors/packet-discard.c
;; RFC 863
...
(def (dissect-discard buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "DISCARD parse error: " e)))))

;; dissect-discard: parse DISCARD from bytevector
