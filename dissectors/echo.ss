...
;; jerboa-ethereal/dissectors/echo.ss
;; Auto-generated from wireshark/epan/dissectors/packet-echo.c
;; RFC 862
...
(def (dissect-echo buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "ECHO parse error: " e)))))

;; dissect-echo: parse ECHO from bytevector
