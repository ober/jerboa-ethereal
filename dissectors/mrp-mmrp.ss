...
;; jerboa-ethereal/dissectors/mrp-mmrp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-mrp_mmrp.c
...
(def (dissect-mrp-mmrp buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "MRP-MMRP parse error: " e)))))

;; dissect-mrp-mmrp: parse MRP-MMRP from bytevector
