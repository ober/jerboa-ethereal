...
;; jerboa-ethereal/dissectors/megaco.ss
;; Auto-generated from wireshark/epan/dissectors/packet-megaco.c
;; RFC 3015
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-megaco buffer)
  "MEGACO"
  (try
    ;; TODO: no extractable fields found for megaco
    (ok '())

    (catch (e)
      (err (str "MEGACO parse error: " e)))))

;; dissect-megaco: parse MEGACO from bytevector
