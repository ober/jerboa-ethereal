...
(def (dissect-selfm buffer)
  ...
  (try
    (let* (
           ...
           (fastmsg-len (unwrap (read-u8 buffer 134)))
           (fastmsg-routing-addr (unwrap (slice buffer 134 5)))
           (fastmsg-status (unwrap (read-u8 buffer 140)))
           (fastmsg-seq (unwrap (read-u8 buffer 142)))
           ...
           (fastmsg-resp-num (unwrap (read-u8 buffer 143)))
           (fastmsg-uns-en-fc-data (unwrap (slice buffer 144 3)))
           (fastmsg-uns-dis-fc-data (unwrap (slice buffer 148 1)))
           (fastmsg-soe-req-orig (unwrap (slice buffer 158 4)))
           (fastmsg-unsresp-orig (unwrap (slice buffer 162 4)))
           (fastmsg-unsresp-doy (unwrap (read-u16be buffer 166)))
           (fastmsg-unsresp-year (unwrap (read-u16be buffer 166)))
           (fastmsg-unsresp-todms (unwrap (read-u32be buffer 166)))
           (fastmsg-unsresp-elmt-idx (unwrap (read-u8 buffer 174)))
           (fastmsg-unsresp-elmt-ts-ofs (unwrap (read-u32be buffer 174)))
           (fastmsg-unsresp-elmt-ts-ofs-decoded (unwrap (read-u24be buffer 174)))
           (fastmsg-unsresp-eor (unwrap (slice buffer 178 4)))
           (fastmsg-unsresp-elmt-statword (unwrap (read-u32be buffer 182)))
           (fastmsg-unswrite-addr2 (unwrap (read-u16be buffer 186)))
           (fastmsg-unswrite-num-reg (unwrap (read-u16be buffer 186)))
           (fastmsg-unswrite-reg-val (unwrap (read-u16be buffer 192)))
           (fastmsg-def-route-sup (unwrap (read-u8 buffer 202)))
           (fastmsg-def-rx-stat (unwrap (read-u8 buffer 203)))
           (fastmsg-def-tx-stat (unwrap (read-u8 buffer 203)))
           (fastmsg-def-rx-maxfr (unwrap (read-u8 buffer 205)))
           (fastmsg-def-tx-maxfr (unwrap (read-u8 buffer 205)))
           (fastmsg-def-rx-num-fc (unwrap (read-u8 buffer 213)))
           (fastmsg-def-tx-num-fc (unwrap (read-u8 buffer 216)))
           (fastmsg-soe-resp-numblks (unwrap (read-u16be buffer 219)))
           (fastmsg-soe-resp-orig (unwrap (slice buffer 221 4)))
           (fastmsg-soe-resp-numbits (unwrap (read-u8 buffer 221)))
           (fastmsg-soe-resp-pad (unwrap (read-u8 buffer 221)))
           (fastmsg-soe-resp-doy (unwrap (read-u16be buffer 221)))
           (fastmsg-soe-resp-year (unwrap (read-u16be buffer 221)))
           (fastmsg-soe-resp-tod (unwrap (read-u32be buffer 221)))
           (fastmsg-soe-resp-data (unwrap (read-u16be buffer 235)))
           (fid (unwrap (slice buffer 237 50)))
           (rid (unwrap (slice buffer 237 40)))
           (fastmsg-devdesc-num-region (unwrap (read-u16be buffer 327)))
           (fastmsg-devdesc-num-ctrl (unwrap (read-u16be buffer 329)))
           (fastmsg-data-region-name (unwrap (slice buffer 331 10)))
           (fastmsg-numwords (unwrap (read-u16be buffer 345)))
           (fastmsg-flags (unwrap (read-u16be buffer 347)))
           (fastmsg-baseaddr (unwrap (read-u32be buffer 357)))
           (fastmsg-datafmt-resp-numitem (unwrap (read-u16be buffer 361)))
           (fastmsg-dataitem-qty (unwrap (read-u16be buffer 363)))
           (fastmsg-crc16 (unwrap (read-u16be buffer 377)))
           (relaydef-len (unwrap (read-u8 buffer 379)))
           )
