...
;; jerboa-ethereal/dissectors/vssmonitoring.ss
;; Auto-generated from wireshark/epan/dissectors/packet-vssmonitoring.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-vssmonitoring buffer)
  "VSS Monitoring Ethernet trailer"
  (try
    (let* (
           (srcport (unwrap (read-u16be buffer 8)))
           )
    ...
    (catch (e)
      (err (str "VSSMONITORING parse error: " e)))))

;; dissect-vssmonitoring: parse VSSMONITORING from bytevector
