...
;; jerboa-ethereal/dissectors/mikey.ss
;; Auto-generated from wireshark/epan/dissectors/packet-mikey.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-mikey buffer)
  "Multimedia Internet KEYing"
  (try
    ;; TODO: no extractable fields found for mikey
    (ok '())

    (catch (e)
      (err (str "MIKEY parse error: " e)))))

;; dissect-mikey: parse MIKEY from bytevector
