...
;; jerboa-ethereal/dissectors/rgmp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-rgmp.c
;; RFC 3488
...
(def (dissect-rgmp buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "RGMP parse error: " e)))))

;; dissect-rgmp: parse RGMP from bytevector
