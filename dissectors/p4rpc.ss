...
;; jerboa-ethereal/dissectors/p4rpc.ss
;; Auto-generated from wireshark/epan/dissectors/packet-p4rpc.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-p4rpc buffer)
  "P4RPC (Perforce Protocol)"
  (try
    (let* (
    ...
    (catch (e)
      (err (str "P4RPC parse error: " e)))))

;; dissect-p4rpc: parse P4RPC from bytevector
