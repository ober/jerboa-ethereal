...
;; jerboa-ethereal/dissectors/moldudp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-moldudp.c
...
(def (dissect-moldudp buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "MOLDUDP parse error: " e)))))

;; dissect-moldudp: parse MOLDUDP from bytevector
