...
;; jerboa-ethereal/dissectors/mle.ss
;; Auto-generated from wireshark/epan/dissectors/packet-mle.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-mle buffer)
  "Mesh Link Establishment"
  (try
    (let* (
           (mic (unwrap (slice buffer 0 1)))
           )
    ...
    (catch (e)
      (err (str "MLE parse error: " e)))))

;; dissect-mle: parse MLE from bytevector
