...
;; jerboa-ethereal/dissectors/msrcp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-msrcp.c
...
(def (dissect-msrcp buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "MSRCP parse error: " e)))))

;; dissect-msrcp: parse MSRCP from bytevector
