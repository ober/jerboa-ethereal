...
(def (dissect-someip-sd buffer)
  ...
  (try
    (let* (
           (sd-option-config-string-element (unwrap (slice buffer 0 1)))
           ...
           (sd-option-lb-priority (unwrap (read-u16be buffer 4)))
           (sd-length-entriesarray (unwrap (read-u32be buffer 4)))
           (sd-option-lb-weight (unwrap (read-u16be buffer 6)))
           (sd-length-optionsarray (unwrap (read-u32be buffer 8)))
           (sd-option-ipv4 (unwrap (read-u32be buffer 10)))
           (sd-option-ipv6 (unwrap (slice buffer 20 16)))
           (sd-option-reserved2 (unwrap (slice buffer 36 1)))
           (sd-option-proto (unwrap (read-u8 buffer 37)))
           (sd-option-port (unwrap (read-u16be buffer 38)))
           (sd-option-length (unwrap (read-u16be buffer 38)))
           (sd-option-type (unwrap (read-u8 buffer 40)))
           (sd-option-reserved (unwrap (slice buffer 41 1)))
           (sd-option-data (unwrap (slice buffer 42 1)))
           (sd-entry-type (unwrap (read-u8 buffer 42)))
           (sd-entry-index1 (unwrap (read-u8 buffer 43)))
           (sd-entry-index2 (unwrap (read-u8 buffer 44)))
           (sd-entry-numopt1 (unwrap (read-u8 buffer 45)))
           (sd-entry-numopt2 (unwrap (read-u8 buffer 45)))
           (sd-entry-opts-referenced (unwrap (slice buffer 46 3)))
           (sd-entry-servicename (unwrap (slice buffer 46 2)))
           (sd-entry-ttl (unwrap (read-u24be buffer 51)))
           (sd-entry-reserved (unwrap (read-u8 buffer 54)))
           (sd-entry-intial-event-flag (unwrap (read-u8 buffer 55)))
           (sd-entry-reserved2 (unwrap (read-u8 buffer 55)))
           (sd-entry-counter (unwrap (read-u8 buffer 55)))
           (sd-entry-eventgroupname (unwrap (slice buffer 56 2)))
           )
