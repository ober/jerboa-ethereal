...
;; jerboa-ethereal/dissectors/prp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-prp.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-prp buffer)
  "Parallel Redundancy Protocol (IEC62439 Part 3)"
  (try
    ;; TODO: no extractable fields found for prp
    (ok '())

    (catch (e)
      (err (str "PRP parse error: " e)))))

;; dissect-prp: parse PRP from bytevector
