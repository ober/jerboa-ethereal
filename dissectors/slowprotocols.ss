...
;; jerboa-ethereal/dissectors/slowprotocols.ss
;; Auto-generated from wireshark/epan/dissectors/packet-slowprotocols.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-slowprotocols buffer)
  "802.3 Slow protocols"
  (try
    ;; TODO: no extractable fields found for slowprotocols
    (ok '())

    (catch (e)
      (err (str "SLOWPROTOCOLS parse error: " e)))))

;; dissect-slowprotocols: parse SLOWPROTOCOLS from bytevector
