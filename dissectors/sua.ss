...
;; jerboa-ethereal/dissectors/sua.ss
;; Auto-generated from wireshark/epan/dissectors/packet-sua.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-sua buffer)
  "SS7 SCCP-User Adaptation Layer"
  (try
    ;; TODO: no extractable fields found for sua
    (ok '())

    (catch (e)
      (err (str "SUA parse error: " e)))))

;; dissect-sua: parse SUA from bytevector
