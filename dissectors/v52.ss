...
;; jerboa-ethereal/dissectors/v52.ss
;; Auto-generated from wireshark/epan/dissectors/packet-v52.c
...
(def (dissect-v52 buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "V52 parse error: " e)))))

;; dissect-v52: parse V52 from bytevector
