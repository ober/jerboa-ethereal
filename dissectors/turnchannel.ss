...
;; jerboa-ethereal/dissectors/turnchannel.ss
;; Auto-generated from wireshark/epan/dissectors/packet-turnchannel.c
;; RFC 5389
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-turnchannel buffer)
  "TURN Channel"
  (try
    (let* (
    ...
    (catch (e)
      (err (str "TURNCHANNEL parse error: " e)))))

;; dissect-turnchannel: parse TURNCHANNEL from bytevector
