...
(def (dissect-scylla buffer)
  ...
  (try
    (let* (
           ...
           (response-size (unwrap (read-u32be buffer 0)))
           ...
           (mut-size2 (unwrap (read-u32be buffer 28)))
           (mut-table-id (unwrap (slice buffer 28 16)))
           (mut-schema-id (unwrap (slice buffer 28 16)))
           (mut-len-pkeys (unwrap (read-u32be buffer 28)))
           (mut-num-pkeys (unwrap (read-u32be buffer 28)))
           (mut-len-pkey (unwrap (read-u32be buffer 28)))
           (mut-pkey (unwrap (slice buffer 28 1)))
           (payload (unwrap (slice buffer 28 1)))
           (read-data-timeout (unwrap (read-u32be buffer 28)))
           (read-data-table-id (unwrap (slice buffer 28 16)))
           (read-data-schema-version (unwrap (slice buffer 28 16)))
           )
