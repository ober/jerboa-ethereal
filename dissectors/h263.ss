...
;; jerboa-ethereal/dissectors/h263.ss
;; Auto-generated from wireshark/epan/dissectors/packet-h263.c
...
(def (dissect-h263 buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "H263 parse error: " e)))))

;; dissect-h263: parse H263 from bytevector
