...
;; jerboa-ethereal/dissectors/lsd.ss
;; Auto-generated from wireshark/epan/dissectors/packet-lsd.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-lsd buffer)
  "Local Service Discovery"
  (try
    (let* (
           (header (unwrap (slice buffer 0 1)))
           (port (unwrap (read-u32be buffer 0)))
           )
    ...
    (catch (e)
      (err (str "LSD parse error: " e)))))

;; dissect-lsd: parse LSD from bytevector
