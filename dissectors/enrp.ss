...
;; jerboa-ethereal/dissectors/enrp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-enrp.c
;; RFC 5353
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-enrp buffer)
  "Endpoint Handlespace Redundancy Protocol"
  (try
    ;; TODO: no extractable fields found for enrp
    (ok '())

    (catch (e)
      (err (str "ENRP parse error: " e)))))

;; dissect-enrp: parse ENRP from bytevector
