...
;; jerboa-ethereal/dissectors/t38.ss
;; Auto-generated from wireshark/epan/dissectors/packet-t38.c
...
(def (dissect-t38 buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "T38 parse error: " e)))))

;; dissect-t38: parse T38 from bytevector
