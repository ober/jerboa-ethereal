...
;; jerboa-ethereal/dissectors/hcrt.ss
;; Auto-generated from wireshark/epan/dissectors/packet-hcrt.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-hcrt buffer)
  "Hotline Command-Response Transaction protocol"
  (try
    ;; TODO: no extractable fields found for hcrt
    (ok '())

    (catch (e)
      (err (str "HCRT parse error: " e)))))

;; dissect-hcrt: parse HCRT from bytevector
