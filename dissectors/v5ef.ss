...
;; jerboa-ethereal/dissectors/v5ef.ss
;; Auto-generated from wireshark/epan/dissectors/packet-v5ef.c
...
(def (dissect-v5ef buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "V5EF parse error: " e)))))

;; dissect-v5ef: parse V5EF from bytevector
