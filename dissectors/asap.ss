...
;; jerboa-ethereal/dissectors/asap.ss
;; Auto-generated from wireshark/epan/dissectors/packet-asap.c
;; RFC 5352
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-asap buffer)
  "Aggregate Server Access Protocol"
  (try
    ;; TODO: no extractable fields found for asap
    (ok '())

    (catch (e)
      (err (str "ASAP parse error: " e)))))

;; dissect-asap: parse ASAP from bytevector
