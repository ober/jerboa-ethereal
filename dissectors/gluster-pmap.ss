...
;; jerboa-ethereal/dissectors/gluster-pmap.ss
;; Auto-generated from wireshark/epan/dissectors/packet-gluster_pmap.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-gluster-pmap buffer)
  "Gluster Portmap"
  (try
    ;; TODO: no extractable fields found for gluster-pmap
    (ok '())

    (catch (e)
      (err (str "GLUSTER-PMAP parse error: " e)))))

;; dissect-gluster-pmap: parse GLUSTER-PMAP from bytevector
