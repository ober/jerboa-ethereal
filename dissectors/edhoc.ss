...
;; jerboa-ethereal/dissectors/edhoc.ss
;; Auto-generated from wireshark/epan/dissectors/packet-edhoc.c
;; RFC 9528
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-edhoc buffer)
  "Ephemeral Diffie-Hellman Over COSE"
  (try
    (let* (
           (idx (unwrap (read-u64be buffer 0)))
           )
    ...
    (catch (e)
      (err (str "EDHOC parse error: " e)))))

;; dissect-edhoc: parse EDHOC from bytevector
