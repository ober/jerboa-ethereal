...
;; jerboa-ethereal/dissectors/fcoe.ss
;; Auto-generated from wireshark/epan/dissectors/packet-fcoe.c
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-fcoe buffer)
  "Fibre Channel over Ethernet"
  (try
    (let* (
           (len (unwrap (read-u32be buffer 0)))
           (ver (unwrap (read-u32be buffer 0)))
           )
    ...
    (catch (e)
      (err (str "FCOE parse error: " e)))))

;; dissect-fcoe: parse FCOE from bytevector
