...
;; jerboa-ethereal/dissectors/gssapi.ss
;; Auto-generated from wireshark/epan/dissectors/packet-gssapi.c
...
(def (dissect-gssapi buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "GSSAPI parse error: " e)))))

;; dissect-gssapi: parse GSSAPI from bytevector
