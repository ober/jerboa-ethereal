...
;; jerboa-ethereal/dissectors/nntp.ss
;; Auto-generated from wireshark/epan/dissectors/packet-nntp.c
...
(def (dissect-nntp buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "NNTP parse error: " e)))))

;; dissect-nntp: parse NNTP from bytevector
