...
;; jerboa-ethereal/dissectors/bpq.ss
;; Auto-generated from wireshark/epan/dissectors/packet-bpq.c
...
(def (dissect-bpq buffer)
  ...
  (try
    ...
    (catch (e)
      (err (str "BPQ parse error: " e)))))

;; dissect-bpq: parse BPQ from bytevector
