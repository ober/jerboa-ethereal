...
;; jerboa-ethereal/dissectors/asap+enrp-common.ss
;; Auto-generated from wireshark/epan/dissectors/packet-asap+enrp_common.c
;; RFC 5352
...
;; ── Dissector ──────────────────────────────────────────────────────
(def (dissect-asap+enrp-common buffer)
  "asap+enrp-common dissector"
  (try
    ;; TODO: no extractable fields found for asap+enrp-common
    (ok '())

    (catch (e)
      (err (str "ASAP+ENRP-COMMON parse error: " e)))))

;; dissect-asap+enrp-common: parse ASAP+ENRP-COMMON from bytevector
